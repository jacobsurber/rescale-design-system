...
const StatusIcon = styled.div<{ 
  ...
  color: ${props => {
    switch (props.$status) {
      case 'running': return 'var(--rescale-color-brand-blue)';
      case 'completed': return 'var(--rescale-color-success)';
      case 'failed': return 'var(--rescale-color-error)';
      case 'warning': return 'var(--rescale-color-warning)';
      case 'queued': return 'var(--rescale-color-gray-600)';
      case 'pending': return 'var(--rescale-color-gray-500)';
...
export const JobStatusIndicator: React.FC<JobStatusIndicatorProps> = ({
  ...
  const getProgressColor = () => {
    switch (status) {
      case 'running':
        return 'var(--rescale-color-brand-blue)';
      case 'completed':
