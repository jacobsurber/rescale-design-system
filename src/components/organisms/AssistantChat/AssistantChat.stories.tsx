...
to provide contextual assistance to users.
  ...
  argTypes: {
    ...
    position: {
      ...
      description: 'Chat position on screen',
    },
    theme: {
      control: 'select',
      options: ['default', 'figma', 'custom'],
...
/**
 * Figma-styled theme with custom colors and styling
 */
export const FigmaTheme: Story = {
  args: {
    theme: 'figma',
    defaultOpen: true,
    messages: [
      {
        id: '1',
        content: 'Welcome! This is the Figma-styled theme with custom colors and styling.',
        sender: 'assistant',
        timestamp: new Date(Date.now() - 60000),
      },
      {
        id: '2', 
        content: 'The styling matches the Figma design specifications.',
        sender: 'user',
  ...
  parameters: {
    docs: {
      description: {
        story: 'AssistantChat with Figma theme styling using design system colors.',
      },
    },
  },
};
...
/**
 * Custom theme with personalized styling
 */
export const CustomTheme: Story = {
  args: {
    ...
    themeConfig: {
      floatButton: {
        backgroundColor: '#7d53b3',
        boxShadow: '0 4px 12px rgba(125, 83, 179, 0.4)',
      },
      header: {
    ...
    messages: [
      {
        id: '1',
        content: 'This demonstrates a custom theme configuration.',
        sender: 'assistant', 
        timestamp: new Date(Date.now() - 60000),
      },
    ],
  ...
  parameters: {
    docs: {
      description: {
        story: 'AssistantChat with custom theme configuration showing full customization options.',
      },
    },
  },
};